...
public class MoveBehaviour : GenericBehaviour
{
    ...
    private void Start()
    {
        ...
        behaviourController.SubCribeBehaviour(this);
    ...
    Vector3 Rotating(float horizontal ,float vertical)
    {
        ...
        {
            //움직이고자 하는 방향의 로테이션을 구함
            Quaternion targetRotation = Quaternion.LookRotation(targetDirection);
            //그 방향을 구해서 지금 로테이션에서 타겟 로테이션으로 각도 보간한 쿼터니언 값을 가져온다
    ...
    #endregion BehaviourHelper Method
