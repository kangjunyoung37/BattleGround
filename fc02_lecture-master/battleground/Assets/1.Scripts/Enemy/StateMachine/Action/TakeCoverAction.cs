...
{
    private readonly int coverMin = 2;//커버에 머물러있는 최소 최대시간
    ...
    public override void OnReadyAction(StateController controller)
    {
        ...
        {
            controller.enemyAnimation.anim.SetBool(KJY.AnimatorKey.Crouch, true);
    ...
    public override void Act(StateController controller)
    {
        ...
        if(controller.enemyAnimation.anim.GetBool(KJY.AnimatorKey.Crouch))
        {
            Rotating(controller);
        }
    }
