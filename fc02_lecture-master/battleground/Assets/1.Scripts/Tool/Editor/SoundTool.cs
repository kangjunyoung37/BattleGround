...
public class SoundTool : EditorWindow
{
    ...
    static void Int()
    {
        ...
        SoundTool window = GetWindow<SoundTool>(false, "Sound Tool"); //창 띄우기
        window.Show(); 
                    ...
                    this.SP2 = EditorGUILayout.BeginScrollView(this.SP2);
                    {
                        if(soundData.GetDataCount() > 0)
                        {
                            EditorGUILayout.BeginVertical();
                            {
                                ...
                                sound.isLoop = EditorGUILayout.Toggle("LoopCilp", sound.isLoop, GUILayout.Width(uiWidthLarge));
                                EditorGUILayout.Separator();
                                ...
                                if(soundSource != null)
                                {
                                    ...
                                    sound.maxDistane = EditorGUILayout.FloatField("max Distane", sound.maxDistane, GUILayout.Width(uiWidthLarge));
                                ...
                                EditorGUILayout.Separator();
                                if(GUILayout.Button("Add Loop",GUILayout.Width(uiWidthMiddle)))//루프 갱신
                                {
